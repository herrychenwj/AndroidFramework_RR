...
import com.queen.rxjavaretrofitdemo.entity.HttpResult2;
...
//    public static final String BASE_URL = "https://api.douban.com/v2/movie/";
    ...
    public static final String BASE_URL = "https://museum.morview.com/";
...
//                .subscribe(subscriber);
    ...
    public void getNews(Subscriber<List<NewsModel>> subscriber) {

        PostParam postParam = new PostParam();
        postParam.setDevice_id("1");
        Observable observable = movieService.getNews(postParam);
